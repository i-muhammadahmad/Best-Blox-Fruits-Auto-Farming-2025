...
const Results = props => {
  const { className, refershDataTable, setRefershDataTable, actionsCol, extraFiltersState, ...rest } = props;
  ...
  const server_side_request = new Request(API_URL + "user_reports/getAllUserClockInServerSide", {
    method: 'POST',
    headers: {
