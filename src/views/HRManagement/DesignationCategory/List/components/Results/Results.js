...
import {
  designationCategoryServerListSuccess,
  showCommonLoader,
  hideCommonLoader,
  tokenError,
  showGeneralError
...
const Results = props => {
  ...
  const handleDesignationCategorySuccessResponse = (responseObject) => {
  ...
  const call_backs = {
    'serverSideSuccess': () => { dispatch(designationCategoryServerListSuccess()); },
    ...
    'customResponse': (responseObject) => { return handleDesignationCategorySuccessResponse(responseObject) }
  }

  const server_side_request = new Request(API_URL + "designation_categories/getAllServerSide", {
    method: 'POST',
    headers: {
          ...
          <PerfectScrollbar>
            <div className={classes.inner}>
              ...
              <CustomDataGrid
                ...
                gridName="DesignationCategoryGrid"
              />
            </div>
          </PerfectScrollbar>
        </CardContent>
