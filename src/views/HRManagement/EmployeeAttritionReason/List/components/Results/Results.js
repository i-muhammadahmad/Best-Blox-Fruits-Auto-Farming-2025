...
import {
  employeeAttritionReasonServerListSuccess,
  showCommonLoader,
  hideCommonLoader,
  tokenError,
  showGeneralError
...
const Results = props => {
  ...
  const handleEmployeeAttritionReasonSuccessResponse = (responseObject) => {
  ...
  const call_backs = {
    'serverSideSuccess': () => { dispatch(employeeAttritionReasonServerListSuccess()); },
    ...
    'customResponse': (responseObject) => { return handleEmployeeAttritionReasonSuccessResponse(responseObject) }
  }

  const server_side_request = new Request(API_URL + "employeeAttritionReason/getAllServerSide", {
    method: 'POST',
    headers: {
          ...
          <PerfectScrollbar>
            <div className={classes.inner}>
              <CustomDataGrid
                ...
                gridName="ActiivityCategoryStatusGrid"
              />
            </div>
          </PerfectScrollbar>
        </CardContent>
