...
const EmployeeAttritionReasonAdd = () => {
  ...
  const handleSubmit = async event => {
    ...
    dispatch(addEmployeeAttritionReason(formState.values));
  }
  ...
  return (
    <Page
      ...
      title="Add Employee Attrition Reason"
    >
      <Header />
      <Card
        className={classes.projectDetails}
      >
        <CardHeader title="Add Employee Attrition Reason" />
        <CardContent>
        <form
        ...
        >
          ...
          <StyledButton
            ...
            startIcon={<SaveIcon/>}
          >
            Create Employee Attrition Reason
          </StyledButton>&nbsp; &nbsp;
          <StyledButton
            variant="contained"
            color="blight"
...
export default EmployeeAttritionReasonAdd;
