...
const ProductionUnits = props => {
  ...
  return (
    ...
    >
      <BootstrapTooltip title="Showing the count of Activities Logged">
        <div>
          <Typography
            component="h3"
            gutterBottom
          ...
          <div className={classes.details}>
            <Typography variant="h3">
              {!isEmpty(dashboardProductionState.clientProductionSummary) ?
                dashboardProductionState.clientProductionSummary.total_production_unit
                : 0
              }
            </Typography>
          </div>
