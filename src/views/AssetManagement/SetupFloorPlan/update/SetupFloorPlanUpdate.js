...
const SetupFloorPlanUpdate = () => {
  ...
  useEffect(() => {
    let record = setupFloorPlanState.setupFloorPlansRecord
  ...
  }, [setupFloorPlanState.setupFloorPlansRecord]);
  ...
  useEffect(() => {
    if (!setupFloorPlanState.showViewPage && !setupFloorPlanState.showUpdateForm) {
      router.history.push('/setup-floor-plan');
    }
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [setupFloorPlanState.showUpdateForm, setupFloorPlanState.showViewPage]);
  ...
  const handleSubmit = async event => {
    ...
    dispatch(updateSetupFloorPlan(data));
  }
  ...
  return (
    <Page
      ...
      title="Update Setup Floor Plan"
    >
      <Header />
      <Card
        className={classes.projectDetails}
      >
        <CardHeader title="Update Setup Floor Plan" />
        <CardContent>
          <form
          ...
          >
              ...
              <Grid container spacing={3}>
                  ...
                  <Grid container spacing={3}>  
                    <Grid item xs={12} sm={12}>
                      ...
                      <CKEditor
                        ...
                        data={setupFloorPlanState.setupFloorPlansRecord.description || ''}
                ...
                <Grid item xs={4} sm={4}>  
                  <FlagImage
                    files={files}
                    setFiles={setFiles}
                    setupFloorPlanState={setupFloorPlanState}
                  />
                </Grid> 
              </Grid>
            </div>
            <StyledButton
              ...
              startIcon={<SaveIcon />}
            >
              Update Setup Floor Plan
          </StyledButton> &nbsp; &nbsp;
          <StyledButton
              variant="contained"
              color="blight"
              size="small"
              onClick={() => { dispatch(redirectToSetupFloorPlanList()) }}
...
export default SetupFloorPlanUpdate;
