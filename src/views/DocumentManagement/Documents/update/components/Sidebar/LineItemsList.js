		...
		<div className={classes.root}>
			<Paper
				...
				<StyledFab
					...
					aria-label="edit"
					size="small"
					style={{ top: '-23px', right: '-14px', position: 'absolute' }}
				...
				<Grid container spacing={3}>
					...
					<Grid item xs={6} sm={6}>
						<TextField
							id={'access_types_' + lineItem.id}
							name={'access_types_' + lineItem.id}
							select
							error={hasError('type_' + lineItem.id)}
							fullWidth
							helperText={
								hasError('type_' + lineItem.id)
									? formState.errors['type_' + lineItem.id][0]
									: null
							}
							label={'Select Access Types'}
							onChange={e => {
							...
							<RoleDropdown
								...
								renderInput={params => (
									<TextField
										...
										helperText={
											hasError('role_id_' + lineItem.id)
												? formState.errors['role_id_' + lineItem.id][0]
												: null
										}
									/>
								)}
							...
							<UserDropdown
								...
								renderInput={params => (
									<TextField
										...
										helperText={
											hasError('user_id_' + lineItem.id)
												? formState.errors['user_id_' + lineItem.id][0]
												: null
										}
									/>
								)}
