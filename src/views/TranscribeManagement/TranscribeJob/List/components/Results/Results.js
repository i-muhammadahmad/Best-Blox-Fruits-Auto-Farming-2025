...
import {
  transcribeJobServerListSuccess,
  showCommonLoader,
  hideCommonLoader,
  tokenError,
  showGeneralError
...
const Results = props => {
  ...
  const call_backs = {
    'serverSideSuccess': () => { dispatch(transcribeJobServerListSuccess()); },
  ...
  const server_side_request = new Request(API_URL + "transcribe_job/getAllServerSide", {
    method: 'POST',
    headers: {
