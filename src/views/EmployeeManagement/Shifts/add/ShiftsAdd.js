...
import { API_URL, CK_CONFIGS } from 'configs'
...
const ShiftsAdd = () => {
  ...
  const getOfficeListItem = value => {
    return (
      <div className={'actionClass'} style={{ textAlign: 'center', whiteSpace: 'nowrap' }}>
        {(value.flag_image)?
          <>
          <Avatar alt="Avator" src={API_URL+value.flag_image} className={classes.small} />
  ...
  const handleSubmit = async event => {
    ...
    dispatch(addShifts(formState.values));
  }
