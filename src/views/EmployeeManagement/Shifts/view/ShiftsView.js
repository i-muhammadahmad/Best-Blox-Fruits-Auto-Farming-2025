...
import { copyShiftData } from 'actions';
...
const ShiftsView = () => {
  ...
  useEffect(() => {
    if (!shiftsState.showViewPage && !shiftsState.showUpdateForm) {
      router.history.push('/shifts');
    }
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [shiftsState.showViewPage, shiftsState.showUpdateForm]);
