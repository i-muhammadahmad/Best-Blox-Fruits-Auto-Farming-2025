...
const schema = {
  name: {
    presence: { allowEmpty: false, message: '^Departments is required' },
  },
  office_id: {
...
const DepartmentsUpdate = () => {
  ...
  useEffect(() => {
    let record = departmentsState.departmentsRecord
  ...
  }, [departmentsState.departmentsRecord]);
  ...
  const handleSubmit = async event => {
    ...
    dispatch(updateDepartments(formState.values));
  }
  ...
  return (
    ...
    >
      ...
      >
        <CardHeader title="Update Departments" />
        <CardContent>
          <form
          ...
          >
              ...
              <Grid container spacing={3}>
                ...
                <Grid item xs={6} sm={4}>
                  <EmployeeDropdown
                    ...
                    selectedId={formState.values.head_id}
                    id="head_id"
                    name="head_id"
            ...
            <div className={classes.formGroup}>
              <CKEditor
                ...
                data={departmentsState.departmentsRecord.description || ''}
