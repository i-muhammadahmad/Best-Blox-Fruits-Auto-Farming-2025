...
const Results = props => {
  ...
  const handleWorkstationSuccessResponse = (responseObject) => {
  ...
  const call_backs = {
    'serverSideSuccess': () => { dispatch(workstationsServerListSuccess()); },
    ...
    'customResponse': (responseObject) => { return handleWorkstationSuccessResponse(responseObject) }
  }

  const server_side_request = new Request(API_URL + "workstations/getAllServerSide", {
    method: 'POST',
    headers: {
