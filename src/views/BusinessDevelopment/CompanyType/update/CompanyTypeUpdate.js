...
import {
  updateCompanyType,
  hideCompanyTypeValidationError,
...
const schema = {
  opt_display: {
    presence: { allowEmpty: false, message: '^Company Type is required' },
  }
}
...
const CompanyTypeUpdate = () => {
  ...
  useEffect(() => {
    let record = companyTypeState.companyTypeRecord
  ...
  useEffect(() => {
    if (!isEmpty(companyTypeState.validation_error)) {
      const errors = companyTypeState.validation_error;
      setFormState(formState => ({
        ...formState,
        isValid: errors ? false : true,
        errors: errors || {}
  ...
  }, [companyTypeState.validation_error]);
  ...
  const setDescription = description => {
    ...
    dispatch(hideCompanyTypeValidationError('description'))
  }
  ...
  const handleChange = event => {
    ...
    dispatch(hideCompanyTypeValidationError(event.target.name))
  }

  const handleSubmit = async event => {
    event.preventDefault();
    dispatch(updateCompanyType(formState.values));
  }
  ...
  return (
    ...
    >
      ...
      >
        <CardHeader title="Update Company Type" />
        <CardContent>
          <form
          ...
          >
            ...
            <div className={classes.formGroup}>
              <CKEditor
                ...
                data={companyTypeState.companyTypeRecord.description || ''}
          ...
          <StyledButton
              ...
              color="blight"
              size="small"
              onClick={() => { dispatch(redirectToCompanyTypeList()) }}
...
export default CompanyTypeUpdate;
