...
const Results = props => {
  ...
  const handleCompanyTypeSuccessResponse = (responseObject) => {
  ...
  const call_backs = {
    'serverSideSuccess': () => { dispatch(companyTypeServerListSuccess()); },
    ...
    'customResponse': (responseObject) => { return handleCompanyTypeSuccessResponse(responseObject) }
  }

  const server_side_request = new Request(API_URL + "company_type/getAllServerSide", {
    method: 'POST',
    headers: {
          ...
          <PerfectScrollbar>
            <div className={classes.inner}>
              ...
              <CustomDataGrid
                ...
                gridName="ActiivityCategoryGrid"
              />
            </div>
          </PerfectScrollbar>
        </CardContent>
