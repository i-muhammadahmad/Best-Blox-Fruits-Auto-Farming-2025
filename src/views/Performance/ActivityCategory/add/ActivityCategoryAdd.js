        ...
        >
          <div className={classes.formGroup}>
            <Grid container spacing={3}>
              ...
              <Grid item xs={6} sm={4}>
                {(activityCategoryState.activityCategoryParentsList && showParent)?
                  <Autocomplete
                    id="parent_id"
                    value={ParentValue}
                    ...
                    size="small"
                    renderInput={(params) => <TextField {...params} size="small" label="Select Parent KPI" variant="outlined" error={hasError('parent_id')} helperText={hasError('parent_id') ? formState.errors.parent_id[0] : null} />}
                  />
                :''}
                {(showParent === false)?
                  <StyledButton
            ...
            <Grid container spacing={3}>
              <Grid item xs={12} sm={12}>
                <TextField
                  ...
                  fullWidth
                  helperText={hasError('formula') ? formState.errors.formula[0] : null}
                  label="Formula"
                  name="formula"
                  onChange={handleChange}
                  value={formState.values.formula || ''}
                  variant="outlined"
                  size="small"
                />
              </Grid> 
