        ...
        values: {
          ...
          role_access_rights: {
            ...
            [item.object_id]: {
              ...
              'view_deleted': (item.rights_view_deleted == '1') ? true : false,
              'reporting_access_edit': item.reporting_access_edit,
              'reporting_access_delete': item.reporting_access_delete,
              'reporting_access_view': item.reporting_access_view,
        ...
        values: {
          ...
          role_access_rights:{
            ...
            [objectListItem.id]: {
              ...
              'view': false,
              'view_deleted': false,
              'reporting_access_edit': 'disabled',
              'reporting_access_delete': 'disabled',
              'reporting_access_view': 'disabled',
