...
const Results = props => {
  ...
  const call_backs = {
    'serverSideSuccess': () => { dispatch(leaveTypeServerListSuccess()); },
  ...
  const server_side_request = new Request(API_URL + "leave_type/getAllServerSide", {
    method: 'POST',
    headers: {
