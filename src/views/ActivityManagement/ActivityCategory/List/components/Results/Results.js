...
const Results = (props) => {
  ...
  const handleActivityCategorySuccessResponse = (responseObject) => {
  ...
  const call_backs = {
    ...
    'customResponse': (responseObject) => { return handleActivityCategorySuccessResponse(responseObject) }
  }

  const server_side_request = new Request(API_URL + "activity_categories/getAllServerSide", {
    method: 'POST',
    headers: {
