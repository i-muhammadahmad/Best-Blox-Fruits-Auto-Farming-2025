...
const ActivityCategoryView = () => {
  ...
  useEffect(()=> {
    if(!activityCategoryState.showUpdateForm && !activityCategoryState.showViewPage){
      router.history.push('/activity-category');
    }
    // eslint-disable-next-line react-hooks/exhaustive-deps
  },[activityCategoryState.showUpdateForm, activityCategoryState.showViewPage]);
            ...
            <Table className={classes.table} aria-label="simple table">
              <TableBody>
                ...
                <TableRow>
                  ...
                  <TableCell>{
                    !isEmpty(activityCategoryState.activityCategoryRecord.client)?
                    activityCategoryState.activityCategoryRecord.client.client_name:''
                  }</TableCell>
                </TableRow>
                <TableRow>
                ...
                <TableRow>
                  ...
                  <TableCell>{
                    !isEmpty(activityCategoryState.activityCategoryRecord.updated_by_user)?
