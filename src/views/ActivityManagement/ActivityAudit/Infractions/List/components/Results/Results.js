...
const Results = props => {
  ...
  const handleAuditInfractionSuccessResponse = (responseObject) => {
  ...
  const call_backs = {
    'serverSideSuccess': () => { dispatch(infractionsServerListSuccess()); },
    ...
    'customResponse': (responseObject) => { return handleAuditInfractionSuccessResponse(responseObject) }
  }

  const server_side_request = new Request(API_URL + "audit_infractions/getAllServerSide", {
    method: 'POST',
    headers: {
          ...
          <PerfectScrollbar>
            <div className={classes.inner}>
              ...
              <CustomDataGrid
                ...
                gridName="ActiivityInfractionGrid"
              />
            </div>
          </PerfectScrollbar>
        </CardContent>
