...
const QuizSetupView = () => {
  ...
  const [steps, setSteps] = React.useState(['Course Details', 'Slides', 'Bindings']);
  ...
  const getStepContent = (step) => {
    switch (step) {
      case 0:
        return <QuizSetupDisplay />;
      case 1:
        return <QuizSlidesView />;
      case 2:
        return <QuizBindingView />;
      default:
        return 'Unknown step';
    }
  }
