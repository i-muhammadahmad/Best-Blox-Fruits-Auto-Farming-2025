...
const Results = props => {
  const { className, refershDataTable, setRefershDataTable, actionsCol, getQuizStatus, getQuizLastScore, ...rest } = props;
  ...
  const server_side_request = new Request(API_URL + "quiz_binding/getAllServerSide", {
    method: 'POST',
    headers: {
