...
import {
  auditFormInfractionCategoryServerListSuccess,
  showCommonLoader,
  hideCommonLoader,
  tokenError,
  showGeneralError
...
const Results = (props) => {
  ...
  const handleAuditFromInfractionCatSuccessResponse = (responseObject) => {
  ...
  const call_backs = {
    'serverSideSuccess': () => { dispatch(auditFormInfractionCategoryServerListSuccess()); },
    ...
    'customResponse': (responseObject) => { return handleAuditFromInfractionCatSuccessResponse(responseObject) }
  }

  const server_side_request = new Request(API_URL + "auditFormInfractionCategory/getAllServerSide", {
    method: 'POST',
    headers: {
          ...
          <PerfectScrollbar>
            <div className={classes.inner}>
              <CustomDataGrid
                ...
                gridName="AuditFormInfractionCategoryGrid"
              />
            </div>
          </PerfectScrollbar>
        </CardContent>
