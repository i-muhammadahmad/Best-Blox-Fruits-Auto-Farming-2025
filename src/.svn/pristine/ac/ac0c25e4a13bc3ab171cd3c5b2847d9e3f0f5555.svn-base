...
const ActivityCategoryStatusUpdate = () => {
  ...
  useEffect(() => {
    let record = activityCategoryStatusState.activityCategoryStatusRecord
    ...
    const item = find(activityCategoryStatusState.activityCategoryStatusParentsList, ['id', record.parent_id])
    setParentValue(item);
    // eslint-disable-next-line react-hooks/exhaustive-deps
  ...
  const handleSubmit = async event => {
    ...
    dispatch(updateActivityCategoryStatus(formState.values));
  }
  ...
  return (
    <Page
      ...
      title="Update Activity Category Status"
    >
      <Header />
      <Card
        className={classes.projectDetails}
      >
        <CardHeader title="Update Activity Category Status" />
        <CardContent>
          <form
          ...
          >
            ...
            <div className={classes.formGroup}>
              <CKEditor
                ...
                data={activityCategoryStatusState.activityCategoryStatusRecord.description || ''}
            ...
            <StyledButton
              ...
              startIcon={<SaveIcon />}
            >
              Update Activity Category Status
          </StyledButton>&nbsp; &nbsp;
          <StyledButton
              variant="contained"
              color="blight"
...
export default ActivityCategoryStatusUpdate;
