...
const AuditErrorCategoryAdd = () => {
  ...
  const handleSubmit = async event => {
    ...
    dispatch(addAuditErrorCategory(formState.values));
  }
  ...
  return (
    <Page
      ...
      title="Add Audit Error Category"
    >
      <Header />
      <Card
        className={classes.projectDetails}
      >
        <CardHeader title="Add Audit Error Category" />
        <CardContent>
        <form
...
export default AuditErrorCategoryAdd;
