...
const Columns = [
  ...
  createColumn("employee_first_name", {
    dataType: ColumnDataType.String,
    sortable: false,
    filterable: true,
    searchable: true,
  ...
  createColumn("employee_last_name", {
    dataType: ColumnDataType.String,
    sortable: false,
    filterable: true,
    searchable: true,
