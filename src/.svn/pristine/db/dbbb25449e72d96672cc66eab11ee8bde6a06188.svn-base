...
const Results = props => {
  const { className, refershDataTable, setRefershDataTable, extraFiltersState, actionsCol, ...rest } = props;
  ...
  const server_side_request = new Request(API_URL + "assets/getAssetsReportServerSide", {
    method: 'POST',
    headers: {
