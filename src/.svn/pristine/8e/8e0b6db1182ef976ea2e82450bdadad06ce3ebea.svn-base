            ...
            <List className={classes.list}>
              <ListItem>
                <ButtonBase className={classes.image}>
                  <img className={classes.img} alt="complex" src={API_URL+assetTypesState.assetTypesRecord.assets_type_image} />
                </ButtonBase>
              </ListItem>  
            </List>
          }
...
AssetTypeMedia.propTypes = {
  className: PropTypes.string
};

export default AssetTypeMedia;
