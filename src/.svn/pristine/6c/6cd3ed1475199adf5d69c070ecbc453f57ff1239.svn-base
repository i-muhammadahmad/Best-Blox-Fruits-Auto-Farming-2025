...
const WorkstationsAdd = () => {
  ...
  const handleSubmit = async event => {
    ...
    dispatch(addWorkstations(formState.values));
  }
  ...
  return (
    ...
    >
      ...
      >
        <CardHeader title="Add Workstations" />
        <CardContent>
          <form
...
export default WorkstationsAdd;
