...
const LoggedInEmployees = props => {
  ...
  return (
    ...
    >
      <BootstrapTooltip title="Logged in employees, includes those who are working and those who are not logging any production">
        <div>
          <Typography
            component="h3"
            gutterBottom
          ...
          <div className={classes.details}>
            <Typography variant="h3">
              {/*!isEmpty(dashboardProductionState.clientProductionSummary) ?
                dashboardProductionState.clientProductionSummary.total_production
                : 0
              */}
            </Typography>
          </div>
