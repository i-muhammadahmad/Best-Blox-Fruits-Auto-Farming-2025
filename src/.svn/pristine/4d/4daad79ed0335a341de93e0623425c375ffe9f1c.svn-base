...
import { 
  addAuditFormInfractionCategory,
...
const AuditFormInfractionCategoryAdd = () => {
  ...
  const handleSubmit = async event => {
    ...
    dispatch(addAuditFormInfractionCategory(formState.values));
  }
  ...
  return (
    <Page
      ...
      title="Add Infraction Category"
    >
      <Header />
      <Card
        className={classes.projectDetails}
      >
        <CardHeader title="Add Infraction Category" />
        <CardContent>
        <form
        ...
        >
          <div className={classes.formGroup}>
            ...
            <Grid item xs={6} sm={4}>
            {(auditFormInfractionCategoryState.auditFormInfractionCategoryParentsList && showParent)?
            <Autocomplete
              id="parent_id"
              value={ParentValue}
...
export default AuditFormInfractionCategoryAdd;
