...
const ClientHeadcountAdd = () => {
  ...
  const handleSubmit = async event => {
    ...
    if (formState.isValid) {
      ...
      dispatch(addClientHeadcount(form_data));
    }
  }
  ...
  return (
    <Page
      ...
      title="Add Client Headcount"
    >
      <Header />
      <Card
        className={classes.projectDetails}
      >
        <CardHeader title="Add Client Headcount" />
        <CardContent>
          <form
...
export default ClientHeadcountAdd;
