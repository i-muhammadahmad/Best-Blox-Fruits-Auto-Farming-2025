...
const Results = props => {
  ...
  const call_backs = {
    'serverSideSuccess': () => { dispatch(quizSetupServerListSuccess()); },
  ...
  const server_side_request = new Request(API_URL + "quiz/getAllServerSide", {
    method: 'POST',
    headers: {
