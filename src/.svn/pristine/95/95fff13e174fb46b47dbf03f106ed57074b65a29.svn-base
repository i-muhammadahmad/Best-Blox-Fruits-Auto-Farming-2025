...
const ActivityAccessAdd = () => {
  ...
  useEffect(() => {
    let record = activityAccessState.activityAccessRecord
    setFormState(formState => ({
      ...formState,
      values: {
        ...formState.values,
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [activityAccessState.activityAccessRecord])

  useEffect(() => {
    let record = activityAccessState.activityAccessRecord
    const item = find(activityAccessState.activityAccessRolesList, ['id', record.role_id])
    setRoleValue(item);
    // eslint-disable-next-line react-hooks/exhaustive-deps
  ...
  useEffect(() => {
    ...
    let record = activityAccessState.activityAccessRecord;
    const item = find(activitySetupState.activitySetupList, ['id', record.activity_id]);
  ...
  const handleSubmit = async event => {
    ...
    dispatch(updateActivityAccess(formState.values));
  }
  ...
  return (
    <Page
      ...
      title="Update Activity Access"
    >
      <Header />
      <Card
        className={classes.projectDetails}
      >
        <CardHeader title="Update Activity Access" />
        <CardContent>
        <form
        ...
        >
          ...
          <div className={classes.formGroup}>
            <CKEditor
              ...
              data={activityAccessState.activityAccessRecord.description || ''}
