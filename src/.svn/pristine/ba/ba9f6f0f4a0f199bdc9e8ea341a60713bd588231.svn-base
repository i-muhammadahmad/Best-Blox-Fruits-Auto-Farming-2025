...
const ActivityCategoryUpdate = () => {
  ...
  useEffect(() => {
    dispatch(activityCategoryParentListFetch(session.current_page_permissions.object_id))
  ...
  useEffect(() => {
    ...
    const item = find(activityCategoryState.activityCategoryParentsList, ['id', record.parent_id])
    setParentValue(item);
    // eslint-disable-next-line react-hooks/exhaustive-deps
        ...
        >
          <div className={classes.formGroup}>
            ...
            <Autocomplete
              ...
              options={activityCategoryState.activityCategoryParentsList}
          ...
          <div className={classes.formGroup}>
            <CKEditor
              ...
              data={activityCategoryState.activityCategoryRecord.description || ''}
          ...
          <StyledButton
            ...
            color="blight"
            size="small"
            onClick={ ()=>{ dispatch(redirectToActivityCategoryList()) } }
