...
const ContactBoardAdd = () => {
  ...
  const handleSubmit = async event => {
    ...
    dispatch(addContactBoard(formState.values));
  }
  ...
  return (
    <Page
      ...
      title="Add Advisory Board"
    >
      <Header />
      <Card
        className={classes.projectDetails}
      >
        <CardHeader title="Add Advisory Board" />
        <CardContent>
          <form
...
export default ContactBoardAdd;
