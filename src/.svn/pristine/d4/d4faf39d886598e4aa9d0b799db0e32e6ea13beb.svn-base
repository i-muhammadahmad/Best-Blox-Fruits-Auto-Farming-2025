...
const schema = {
  opt_display: {
    presence: { allowEmpty: false, message: '^Error Severity Name is required' },
  },
  clients: {
...
const ErrorSeverityAdd = () => {
  ...
  const handleSubmit = async event => {
    ...
    dispatch(addErrorSeverity(formState.values));
  }
  ...
  return (
    <Page
      ...
      title="Add Audit Error Severity"
    >
      <Header />
      <Card
        className={classes.projectDetails}
      >
        <CardHeader title="Add Audit Error Severity" />
        <CardContent>
        <form
...
export default ErrorSeverityAdd;
