...
const BulkActivitySetupList = () => {
  ...
  const deleteRecord = async () => {
    await dispatch(deleteBulkActivitySetup(bulkActivitySetupId, session.current_page_permissions.object_id));
