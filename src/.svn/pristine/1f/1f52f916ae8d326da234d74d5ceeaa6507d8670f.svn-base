...
const ShiftBreaksAdd = () => {
  ...
  const handleSubmit = async event => {
    ...
    dispatch(addShiftBreaks(formState.values));
  };
  ...
  return (
    <Page className={classes.root} title="Add Shift Breaks">
      <Header />
      <Card className={classes.projectDetails}>
        <CardHeader title="Add Shift Breaks" />
        <CardContent>
