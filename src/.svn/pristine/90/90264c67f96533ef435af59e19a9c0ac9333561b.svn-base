...
const AuditFormSetupAdd = () => {
  ...
  const handleSubmit = async event => {
    ...
    if (formState.isValid) {
      ...
      dispatch(addAuditFormSetup(form_data));
    }
  }
  ...
  return (
    <Page
      ...
      title="Add Audit Form Setup"
    >
      <Header />
      <Card
        className={classes.projectDetails}
      >
        <CardHeader title="Add Audit Form Setup" />
        <CardContent>
          <form
...
export default AuditFormSetupAdd;
