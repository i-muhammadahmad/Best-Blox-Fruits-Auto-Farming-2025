...
const LeaveTypeUpdate = () => {
  ...
  useEffect(() => {
    let record = leaveTypeState.leaveTypeRecord
  ...
  }, [leaveTypeState.leaveTypeRecord])
  ...
  const handleSubmit = async event => {
    ...
    dispatch(updateLeaveType(formState.values));
  }
  ...
  return (
    ...
    >
      ...
      >
        <CardHeader title="Update Leave Type" />
        <CardContent>
          <form
          ...
          >
            ...
            <div className={classes.formGroup}>
              <CKEditor
                ...
                data={leaveTypeState.leaveTypeRecord.description || ''}
