...
const BulkActivitySetupAdd = () => {
  ...
  }, [bulkActivitySetupState.redirect_to_list, router.history]);
  ...
  const handleSubmit = async event => {
    ...
    dispatch(addBulkActivitySetup(Formdata));
  }
  ...
  return (
    <Page
      ...
      title="Add Activities Import Setup"
    >
      <Header />
      <Card
        className={classes.projectDetails}
      >
        <CardHeader title="Add Activities Import Setup" />
        <CardContent>
        <form
        ...
        >
          ...
          <StyledButton
            ...
            startIcon={<SaveIcon />}
          >
            Create Activities Import Setup
          </StyledButton>
          &nbsp; &nbsp;
          <StyledButton
            variant="contained"
...
export default BulkActivitySetupAdd;
